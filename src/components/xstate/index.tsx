...
export const Machine = <TContext, TSchema, TEvent extends EventObject>({ machine, options, renderer }: MachineProps<TContext, TSchema, TEvent>, children?: JSX.Element[]) => <xstate-machine machine={machine} options={options} renderer={renderer}>{...children}</xstate-machine>
...
export const Service = <TContext, TSchema, TEvent extends EventObject>({ service }: ServiceProps<TContext, TSchema, TEvent>, children?: JSX.Element[]) => <xstate-service service={service}>{...children}</xstate-service>
